package com.mycode.hospital.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;

import com.mycode.hospital.mapper.HospitalSetMapper;
import com.mycode.hospital.mapper.ScheduleMapper;
import com.mycode.hospital.model.HospitalSet;
import com.mycode.hospital.model.Schedule;
import com.mycode.hospital.service.ApiService;
import com.mycode.hospital.util.BeanUtils;
import com.mycode.hospital.util.HttpRequestHelper;
...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveHospital(String data) {
        ...
        if(null != respone && 200 == respone.getIntValue("code")) {
            ...
            throw new YtException(respone.getString("message"), 201);
        }
    }
